...
```toml
[dependencies]
burn_p2p = { version = "=0.21.0-pre.38", features = ["burn"] }
```
...
```toml
[dependencies]
burn_p2p_bootstrap = { version = "=0.21.0-pre.38", default-features = false, features = [
  "admin-http",
  "metrics",
  "browser-edge",
  "browser-join",
...
```toml
[dependencies]
burn_p2p_browser = "=0.21.0-pre.38"
burn_p2p_views = "=0.21.0-pre.38"
```
...
```toml
[dependencies]
burn_p2p_app = { version = "=0.21.0-pre.38", default-features = false, features = [
  "interactive",
  "browser-join",
  "web-client",
] }
