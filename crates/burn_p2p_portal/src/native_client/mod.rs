...
fn NativeNodeAppRoot() -> Element {
    ...
    rsx! {
        NodeAppShell {
            ...
            on_edge_input: Option::<EventHandler<String>>::None,
            on_apply_edge: Option::<EventHandler<()>>::None,
            on_toggle_edge_editor: Option::<EventHandler<()>>::None,
        }
    }
}
