...
pub(crate) fn BrowserAppRoot() -> Element {
    ...
    let on_edge_input = move |value: String| edge_input.set(value);

    let on_apply_edge = move |()| {
    ...
    let on_toggle_edge_editor = move |()| {
        edge_editor_open.set(!edge_editor_open());
    };
    ...
    rsx! {
        NodeAppShell {
            ...
            edge_editor_open: edge_editor_open(),
            edge_editable: true,
            ...
            on_edge_input: on_edge_input,
            on_apply_edge: on_apply_edge,
            on_toggle_edge_editor: on_toggle_edge_editor,
        }
    }
}
...
fn reconnect_edge(
    ...
    mut connection_epoch: Signal<u64>,
    bootstrap: &burn_p2p_ui::NodeAppStaticBootstrap,
) {
