...
impl BrowserAppUiState {
    ...
    pub(crate) fn view_or_placeholder(&self) -> BrowserAppClientView {
        self.view.clone().unwrap_or_else(|| BrowserAppClientView {
            ...
            runtime_detail: "Connecting to the selected edge.".into(),
            capability_summary: "checking".into(),
            session_label: "viewer".into(),
            viewer: burn_p2p_ui::BrowserAppViewerView {
            ...
            validation: burn_p2p_ui::BrowserAppValidationView {
            ...
            training: burn_p2p_ui::BrowserAppTrainingView {
            ...
            network: burn_p2p_ui::BrowserAppNetworkView {
