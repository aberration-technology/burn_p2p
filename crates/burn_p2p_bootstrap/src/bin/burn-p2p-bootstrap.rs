...
use burn_p2p_bootstrap::render_browser_portal_html;
#[cfg(all(not(feature = "metrics-indexer"), feature = "artifact-publish"))]
use burn_p2p_bootstrap::render_browser_portal_html_with_artifacts;
#[cfg(all(feature = "metrics-indexer", not(feature = "artifact-publish")))]
use burn_p2p_bootstrap::render_browser_portal_html_with_metrics;
#[cfg(all(feature = "metrics-indexer", feature = "artifact-publish"))]
use burn_p2p_bootstrap::render_browser_portal_html_with_metrics_and_artifacts;
...
#[cfg(test)]
mod tests {
    include!("burn-p2p-bootstrap/tests.rs");
}
