...
pub use burn_p2p_core::{
    ...
    ReductionCertificate, ReleaseTrainManifest, RevisionId, RevisionManifest, RevocationEpoch,
    SocialMode, SocialProfile, StudyId, SupportedWorkload, TargetArtifactManifest,
    TelemetrySummary, UpdateAnnounce, UpdateNormStats, WindowActivation, WindowId, WorkloadId,
};
