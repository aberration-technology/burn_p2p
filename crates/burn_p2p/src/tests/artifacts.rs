    ...
    snapshot.control_plane.validation_quorum_announcements =
        vec![crate::ValidationQuorumAnnouncement {
            ...
            certificate: crate::ValidationQuorumCertificate {
                ...
                merged_artifact_id: Some(crate::ArtifactId::new("merged-artifact-1")),
                eval_protocol_id: Some(crate::ContentId::new("eval-protocol-1")),
                eval_report_ids: vec![
                    crate::ContentId::new("eval-report-1"),
                    crate::ContentId::new("eval-report-2"),
                ],
                promotion_mode: crate::HeadPromotionMode::ValidatorQuorum,
                validator_quorum: 2,
    ...
    snapshot.control_plane.validation_quorum_announcements =
        vec![crate::ValidationQuorumAnnouncement {
            ...
            certificate: crate::ValidationQuorumCertificate {
                ...
                aggregate_artifact_id: crate::ArtifactId::new("aggregate-artifact-1"),
                merged_head_id: crate::HeadId::new("merged"),
                merged_artifact_id: Some(crate::ArtifactId::new("merged-artifact")),
                eval_protocol_id: Some(crate::ContentId::new("eval-protocol-1")),
                eval_report_ids: vec![
                    crate::ContentId::new("eval-report-1"),
                    crate::ContentId::new("eval-report-2"),
