...
pub use schema::{
    ...
    AuthProvider, BackendClass, BackpressurePolicy, BadgeAward, BadgeKind, BrowserCapability,
    ...
    PeerWindowMetrics, PeerWindowStatus, PersistenceClass, Precision, ProfileMode,
