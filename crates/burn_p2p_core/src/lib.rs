...
pub use schema::{
    ...
    HeadDescriptor, HeadEvalReport, HeadEvalStatus, HeadPromotionPolicy, IdentityVisibility,
    ...
    MetricsSyncCursor, MicroShard, NetworkEstimate, NetworkManifest, NetworkManifestBuilder,
    ...
    SocialProfile, SupportedWorkload, SupportedWorkloadBuilder, TargetArtifactManifest,
    TelemetrySummary, TrustBundleExport, TrustScore, TrustedIssuerStatus, UpdateAnnounce,
    UpdateFeatureSketch, UpdateNormStats, ValidationQuorumCertificate, ValidatorCanaryPolicy,
