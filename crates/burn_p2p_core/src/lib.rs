...
pub use schema::{
    ...
    BrowserLoginProvider, BrowserMode, BrowserPortalSnapshot, BrowserReceiptSubmissionResponse,
    BrowserRole, BrowserRolePolicy, BrowserTransportSurface, BrowserVisibilityPolicy,
    ...
    ReleaseTrainManifest, RevisionManifest, RevocationEpoch, SCHEMA_VERSION, SchemaEnvelope,
    SignatureAlgorithm, SignatureMetadata, SignedPayload, SocialMode, SocialProfile,
    SupportedWorkload, TargetArtifactManifest, TelemetrySummary, TrustBundleExport,
    TrustedIssuerStatus, UpdateAnnounce, UpdateNormStats, WindowActivation, WindowId,
    WorkDisposition,
};
