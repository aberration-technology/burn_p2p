...
pub use schema::{
    ...
    AggregationPolicy, AggregationStrategy, ArtifactAlias, ArtifactAliasScope,
    ...
    BrowserPortalSnapshot, BrowserReceiptSubmissionResponse, BrowserRole, BrowserRolePolicy,
    BrowserTransportSurface, BrowserVisibilityPolicy, CanaryEvalReport, CapabilityCard,
