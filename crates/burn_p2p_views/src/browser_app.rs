...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
/// One small formatted metric preview surfaced in app panels.
pub struct BrowserAppMetricPreview {
    /// Stable metric label.
    pub label: String,
...
pub struct BrowserAppValidationView {
    ...
    /// Small preview of the latest validation metrics.
    #[serde(default)]
    pub metric_preview: Vec<BrowserAppMetricPreview>,
}
...
pub struct BrowserAppTrainingView {
    ...
    /// Latest attempted sample or token budget observed for the active assignment.
    #[serde(default)]
    pub slice_target_samples: Option<u64>,
    /// Remaining sample or token budget observed for the active assignment.
    #[serde(default)]
    pub slice_remaining_samples: Option<u64>,
