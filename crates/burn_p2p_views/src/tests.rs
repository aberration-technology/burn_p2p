...
fn merge_topology_views_build_window_load_and_aggregate_dag() {
    ...
    let certificate = ReductionCertificate {
        ...
        evaluation: Some(burn_p2p_core::HeadEvaluationBinding {
            ...
            artifact_id: burn_p2p_core::ArtifactId::new("head-artifact-1"),
            eval_protocol_id: burn_p2p_core::ContentId::new("eval-protocol-a"),
            eval_report_id: burn_p2p_core::ContentId::new("eval-report-a"),
        }),
