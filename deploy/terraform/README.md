...
cargo xtask deploy aws \
  ...
  --bootstrap-image ghcr.io/acme/burn-p2p-bootstrap:0.21.0-pre.13 \
  --reducer-image ghcr.io/acme/burn-p2p-bootstrap:0.21.0-pre.13 \
  --validator-image ghcr.io/acme/burn-p2p-bootstrap:0.21.0-pre.13 \
